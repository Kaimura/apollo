...
* You're familiar with both JavaScript/ES6 and React.
    ...
    * If you get confused by some of the ES6 syntax used throughout the course you can look them up [here](https://www.javascripttutorial.net/es6/javascript-object-destructuring/). Make sure to at least know about destructuring, defaulting as well as naming these.
